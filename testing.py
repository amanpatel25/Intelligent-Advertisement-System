...
face_classifier = cv2.CascadeClassifier(r'D:\Deep Learning\Emotion\haarcascade_frontalface_default.xml')
classifier =load_model(r'D:\Deep Learning\Emotion\model.h5')
